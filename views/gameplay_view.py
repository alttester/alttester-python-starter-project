...
class GameplayView(BaseView):
    ...
    def pause_game(self) -> None:
        pause_button = self.find_element(self.pause_button_locator)
        pause_button.click()
        Reporter.log("Game paused")

    @allure.step("Resume the game")
    def resume_game(self) -> None:
        resume_button = self.find_element(self.resume_button_locator)
        resume_button.click()
    ...
    def is_main_character_present(self) -> bool:
        try:
            main_character = self.find_element(self.main_character_locator)
    ...
    def is_gameplay_hud_visible(self) -> bool:
        try:
            game_hud = self.find_element(self.game_hud_locator)
